(function () {
  window.CFA_EPISODE_ONE = {
    title: "CFA Reading Session 01",
    kicker: "CFA Reading Session / Level I 2024",
    tagline: "Rates and Returns I",
    description:
      "Teleprompter script for a calm 45 to 55 minute reading session based on CFA Level I 2024 Volume 1, front matter plus the opening of Learning Module 1.",
    images: [],
    markdown: String.raw`# CFA READING SESSION 01
