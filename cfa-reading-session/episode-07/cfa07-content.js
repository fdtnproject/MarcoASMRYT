(function () {
  window.CFA_EPISODE_SEVEN = {
    title: "CFA Reading Session 07",
    kicker: "CFA Reading Session / Level I 2024",
    tagline: "Probability Trees and Conditional Expectations",
    description:
      "Teleprompter script for a calm 40 to 55 minute reading session based on CFA Level I 2024 Volume 1, completing Learning Module 4 on expected value, variance, probability trees, conditional expectations, and Bayes' formula.",
    images: [],
    markdown: String.raw`# CFA READING SESSION 07
...
![Original PDF page 143 - Learning Module 4 opening](./visuals/pdf-original/page-143-original.png)

![Original PDF page 144 - Learning Module 4 overview and expected value opening](./visuals/pdf-original/page-144-original.png)
...
![Original PDF page 145 - expected value and variance formulas with BankCorp example opening](./visuals/pdf-original/page-145-original.png)
...
![Original PDF page 146 - BankCorp expected EPS, variance, and standard deviation](./visuals/pdf-original/page-146-original.png)
...
![Original PDF page 147 - conditional expected value and total probability rule](./visuals/pdf-original/page-147-original.png)
...
![Original PDF page 148 - BankCorp interest-rate tree and conditional EPS means](./visuals/pdf-original/page-148-original.png)
...
![Original PDF page 150 - operating-cost calculations and transition to question set](./visuals/pdf-original/page-150-original.png)
...
![Original PDF page 151 - recovery question set and bridge to Bayes](./visuals/pdf-original/page-151-original.png)
...
![Original PDF page 152 - Bayes formula explained](./visuals/pdf-original/page-152-original.png)
...
![Original PDF page 153 - tech versus non-tech frequency tree](./visuals/pdf-original/page-153-original.png)
...
![Original PDF page 154 - Bayes result and DriveMed setup](./visuals/pdf-original/page-154-original.png)
...
![Original PDF page 155 - DriveMed posterior for exceeded-consensus case](./visuals/pdf-original/page-155-original.png)
...
![Original PDF page 156 - posterior updates for met and fell-short cases](./visuals/pdf-original/page-156-original.png)
...
![Original PDF page 157 - posterior probabilities sum check and diffuse-prior case](./visuals/pdf-original/page-157-original.png)
...
![Original PDF page 158 - Bayes question set on timely repayment and pass/fail tests begins](./visuals/pdf-original/page-158-original.png)
...
![Original PDF page 159 - Bayes question set on survival test continues](./visuals/pdf-original/page-159-original.png)
...
![Original PDF page 160 - final Bayes questions on bond failure and CEO firing](./visuals/pdf-original/page-160-original.png)
...
![Original PDF page 161 - practice problems on expected recovery and sales volatility](./visuals/pdf-original/page-161-original.png)
...
![Original PDF page 162 - solutions for the practice problems](./visuals/pdf-original/page-162-original.png)
